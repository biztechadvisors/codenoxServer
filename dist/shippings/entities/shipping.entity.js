...
let Shipping = class Shipping extends core_entity_1.CoreEntity {
    static _OPENAPI_METADATA_FACTORY() {
        return { id: { required: true, type: () => Number }, name: { required: true, type: () => String }, amount: { required: true, type: () => Number }, is_global: { required: true, type: () => Boolean }, type: { required: true, enum: require("./shipping.entity").ShippingType } };
    }
};
__decorate([
