...
class GetShippingsDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { text: { required: false, type: () => String }, orderBy: { required: false, enum: require("./get-shippings.dto").QueryShippingClassesOrderByColumn }, sortedBy: { required: false, enum: require("../../common/dto/generic-conditions.dto").SortOrder }, search: { required: false, type: () => String } };
    }
}
