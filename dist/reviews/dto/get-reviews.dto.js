...
class GetReviewsDto extends pagination_args_dto_1.PaginationArgs {
    static _OPENAPI_METADATA_FACTORY() {
        return { orderBy: { required: false, enum: require("./get-reviews.dto").QueryReviewsOrderByColumn }, sortedBy: { required: false, enum: require("../../common/dto/generic-conditions.dto").SortOrder }, search: { required: false, type: () => String }, product_id: { required: false, type: () => String }, limit: { required: true, type: () => Number }, page: { required: true, type: () => Number }, shopSlug: { required: false, type: () => String }, userId: { required: false, type: () => Number } };
    }
}
