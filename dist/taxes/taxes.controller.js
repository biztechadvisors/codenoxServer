...
let TaxesController = class TaxesController {
    ...
    createValidateGST(validateGstDto) {
        return this.taxesService.validateGST(validateGstDto.gstNumber);
    }
    async findAll(shopId, shopSlug) {
        if (!shopId && !shopSlug) {
            throw new common_1.NotFoundException('Shop ID or Shop Slug is required');
        }
...
__decorate([
    (0, common_1.Post)('/validate-gst'),
    openapi.ApiResponse({ status: 201, type: Boolean }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [create_tax_dto_1.ValidateGstDto]),
    __metadata("design:returntype", void 0)
], TaxesController.prototype, "createValidateGST", null);
__decorate([
    (0, common_1.Get)(),
    openapi.ApiResponse({ status: 200, type: [require("./entities/tax.entity").Tax] }),
    __param(0, (0, common_1.Query)('shopId')),
    __param(1, (0, common_1.Query)('shopSlug')),
    __metadata("design:type", Function),
