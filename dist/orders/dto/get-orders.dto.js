...
class GetOrdersDto extends pagination_args_dto_1.PaginationArgs {
    static _OPENAPI_METADATA_FACTORY() {
        return { tracking_number: { required: false, type: () => String }, orderBy: { required: false, type: () => String }, sortedBy: { required: false, type: () => String }, customer_id: { required: false, type: () => Number }, shop_id: { required: false, type: () => String }, shopSlug: { required: false, type: () => String }, soldByUserAddress: { required: false, type: () => String }, search: { required: false, type: () => String }, type: { required: false, type: () => Object }, startDate: { required: false, type: () => String }, endDate: { required: false, type: () => String } };
    }
}
