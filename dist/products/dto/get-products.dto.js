...
exports.QueryProductsOrderByColumn = exports.GetProductsDto = exports.ProductPaginator = exports.ProductType = exports.ProductStatus = void 0;
...
class GetProductsDto extends pagination_args_dto_1.PaginationArgs {
    static _OPENAPI_METADATA_FACTORY() {
        return { orderBy: { required: false, type: () => String }, sortedBy: { required: false, type: () => String }, searchJoin: { required: false, type: () => String }, search: { required: false, type: () => String }, filter: { required: false, type: () => String }, date_range: { required: false, type: () => String }, language: { required: false, type: () => String }, with: { required: false, type: () => String }, minPrice: { required: false, type: () => Number }, maxPrice: { required: false, type: () => Number }, dealerId: { required: false, type: () => Number }, shop_id: { required: false, type: () => Number }, shopName: { required: false, type: () => String }, regionNames: { required: false, type: () => Object } };
    }
}
