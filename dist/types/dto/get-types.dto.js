...
class GetTypesDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { orderBy: { required: false, type: () => [require("./get-types.dto").QueryTypesOrderByOrderByClause] }, text: { required: false, type: () => String }, language: { required: false, type: () => String }, shop_id: { required: false, type: () => Number }, shopSlug: { required: false, type: () => String }, search: { required: false, type: () => String }, region_name: { required: false, type: () => String } };
    }
}
