...
export declare class AuthService {
    ...
    constructor(userRepository: Repository<User>, permissionRepository: Repository<Permission>, jwtService: JwtService, mailService: MailService, sessionService: SessionService, analyticsService: AnalyticsService, notificationService: NotificationService, configService: ConfigService);
    private sendSms;
