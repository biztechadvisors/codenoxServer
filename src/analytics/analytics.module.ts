...
@Module({
  imports: [TypeOrmExModule.forCustomRepository([UserAddressRepository]),
  TypeOrmModule.forFeature([Analytics, TotalYearSaleByMonth, Order, Shop, User, Permission, UserAddress, StocksSellOrd]),
  JwtModule.register({}),
