...
@Module({
  imports: [
    ...
    TypeOrmModule.forFeature([Order, Dealer, OrderStatus, User, Product, OrderFiles, Coupon, PaymentIntent, OrderProductPivot, PaymentIntentInfo, Shop, Permission]), // Include Order and OrderStatus here
    HttpModule,
  ],
  controllers: [
    OrdersController,
