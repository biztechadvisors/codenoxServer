...
@Module({
  imports: [TypeOrmModule.forFeature([Product, OrderProductPivot, Variation, VariationOption, Attachment, Category, Shop, Type, Tag, AttributeValue, File, Tax, Dealer, DealerProductMargin, DealerCategoryMargin, User])],
