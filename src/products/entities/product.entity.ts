...
export class Product extends CoreEntity {
  ...
  @ManyToMany(() => Region, (region) => region.products, { nullable: true })
  @JoinTable({
  ...
  @ManyToMany(() => Variation, { cascade: true, onDelete: 'CASCADE' })
  @JoinTable({
  ...
  @OneToMany(
    () => OrderProductPivot,
    (orderProductPivot) => orderProductPivot.product,
  )
...
export class OrderProductPivot extends CoreEntity {
  ...
  @Column()
  subtotal: number
  @ManyToOne(() => Order, (order) => order.orderProductPivots, {
    cascade: true,
  })
